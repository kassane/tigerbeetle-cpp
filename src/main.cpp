// Based: https://github.com/tigerbeetledb/tigerbeetle/blob/main/src/clients/c/samples/main.c
...
auto main() -> int {
  ...
  if (ctx.size == 0) {
      ...
      tb_account_t *results = reinterpret_cast<tb_account_t*>(ctx_->reply.data());
